...
public class CartServiceImpl implements CartService {
    ...
    public List<Cart> findCartListFromRedis(String username) {
        ...
        List<Cart> cartList =  JSON.parseArray((String) redisTemplate.boundHashOps("cartList").get(username),Cart.class);
        if (cartList == null) {
    ...
    public void saveCartListToRedis(String username, List<Cart> cartList) {
        ...
        redisTemplate.boundHashOps("cartList").put(username, JSON.toJSON(cartList).toString());
    }
